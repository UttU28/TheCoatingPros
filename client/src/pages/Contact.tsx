...
export default function Contact() {
  return (
    <>
      <Helmet>
        <title>Contact Us | The Coating Pros</title>
        <meta name="description" content="Get in touch with The Coating Pros for a free estimate on your commercial roof coating project in Houston and Southeast Texas." />
      </Helmet>

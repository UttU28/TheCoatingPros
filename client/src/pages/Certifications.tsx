...
export default function Certifications() {
  return (
    <>
      <Helmet>
        <title>Our Certifications | The Coating Pros</title>
        <meta name="description" content="View our industry certifications and qualifications that make The Coating Pros your trusted roof coating partner." />
      </Helmet>
